            ...
            <div class="nav">
                ...
                <div class="collapse navbar-collapse" id="kegiatanbengkel">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active" style="margin-left: 1rem">
                            <a class="nav-link" href="/request"><div class="sb-nav-link-icon"><i class="fas fa-people-arrows"></i></div>Request Barang</a> <span class="sr-only">(current)</span></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="collapse navbar-collapse" id="storing">
                    <ul class="navbar-nav">
                        <li class="nav-item active" style="margin-left: 1rem">
                            <a class="nav-link" href="/pinjam/tampil"><div class="sb-nav-link-icon"><i class="fa-solid fa-person-walking-arrow-loop-left"></i></div>Peminjaman Barang</a> <span class="sr-only">(current)</span></a>
                        </li>
                    </ul>
                </div>           
            </div>
